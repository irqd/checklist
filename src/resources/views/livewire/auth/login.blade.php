          ...
          <div class="card border-light-subtle shadow-sm">
            <div class="row g-0">
              <div class="col-12 col-md-7">
                <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="{{ asset('images/landscape.jpg') }}" alt="Welcome back you've been missed!">
              </div>
...
{{-- <main class="d-flex justify-content-center align-items-center vh-100 bg-light py-3 py-md-5">
    <div class="container">
      <div class="row justify-content-center">
          ...
          <div class="card border border-light-subtle rounded-3 shadow-sm">
            <div class="card-body p-3 p-md-4 p-xl-5">
              <div class="text-center mb-3">
                <a href="#!">
                  <img src="{{ asset('images/dummy_logo.png') }}" alt="BootstrapBrain Logo" width="175" height="120">
                </a>
              </div>
